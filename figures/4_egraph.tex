...
\draw [double, green, double distance=1.5] (b) -- (f1);
\draw [double, green, double distance=1.5] (f1) -- (f2);
\draw [red] (f3) -- (b);
\draw [->] (f1) -- (b);
\draw [->] (f2) -- (a);
\draw [->] (f3) -- (c);
...
\draw [double, green, double distance=1.5] (b) -- (f1);
\draw [double, green, double distance=1.5] (f1) -- (f2);
\draw [double, green, double distance=1.5] (a) -- (c);
\draw [double, green, double distance=1.5] (f2) -- (f3);
\draw [red] (f3) -- (b);
\draw [->] (f1) -- (b);
\draw [->] (f2) -- (a);
\draw [->] (f3) -- (c);
