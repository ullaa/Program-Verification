...
\end{mytitle}
\lstinputlisting[caption={Modeling a linked list in Viper.},language=viper, label={list}, float] {code/10_fold}
...
\end{mytitle}
\lstinputlisting[caption={Encoding of arrays in Viper.},language=viper, float] {code/10_arrays}
